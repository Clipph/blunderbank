      ...
      <div className="space-y-12">
        <header className="flex flex-col gap-4">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed">
            Eliminate recurring blunders. BlunderBank helps you convert your game-losing mistakes into winning patterns.
          </p>
        </header>
        ...
        {cards.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center space-y-8 rounded-[2.5rem] border-4 border-dashed border-muted p-24 text-center bg-card shadow-sm">
            <div className="mx-auto flex h-28 w-28 items-center justify-center rounded-[2rem] bg-primary/5 shadow-inner">
            ...
            <Button asChild size="lg" className="btn-gradient px-14 h-16 text-xl font-black rounded-3xl shadow-2xl">
